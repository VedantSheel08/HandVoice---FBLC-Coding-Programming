...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('D:\\Pycharm\\ASL- GS\Model\\keras_model.h5')
        ...
        self.root = tk.Tk()
        self.root.title("A Voice For Voiceless")
        self.root.protocol('WM_DELETE_WINDOW', self.destructor)
        self.root.geometry("1300x700")
        self.root.configure(bg="#B3FFFF")

        self.panel = tk.Label(self.root)
        self.panel.place(x=500, y=0, width=480, height=640)
        self.panel.configure(bg="#B3FFFF")
        ...
        self.T.config(text="A Voice For Voiceless : Vedant", font=("Courier", 30, "bold"))
        self.T.configure(bg="#B3FFFF")
        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=280, y=585)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=580)
        self.T1.config(text="Alphabet :", font=("Courier", 30, "bold"))
        ...
        self.T3.config(text="Word Made:", fg="red",  font=("Courier", 30, "bold"))
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("D:\\Pycharm\\ASL- GS\\white.jpg")
    ...
    def predict(self, test_image):
        ...
        print ("CH1 Value is:",ch1,";",  "CH2 Value is:",ch2, ";")
